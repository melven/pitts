...
TEST(PITTS_TensorTrainOperator_apply_op, zero)
{
  using TensorTrainOperator_double = PITTS::TensorTrainOperator<double>;
  using TensorTrain_double = PITTS::TensorTrain<double>;
  constexpr auto eps = 1.e-10;

  TensorTrainOperator_double TTOpA(3, 4, 5);
  TTOpA.setZero();
  ...
  const int nDim = TTOpC.row_dimensions().size();
...
TEST(PITTS_TensorTrainOperator_apply_op, eyeA)
{
  using TensorTrainOperator_double = PITTS::TensorTrainOperator<double>;
  using TensorTrain_double = PITTS::TensorTrain<double>;
  constexpr auto eps = 1.e-10;
...
TEST(PITTS_TensorTrainOperator_apply_op, random)
{
  using TensorTrainOperator_double = PITTS::TensorTrainOperator<double>;
  using TensorTrain_double = PITTS::TensorTrain<double>;
  ...
  TensorTrainOperator_double TTOpA(4, 5, 3);
  randomize(TTOpA);
