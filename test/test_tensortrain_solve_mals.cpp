...
TEST(PITTS_TensorTrain_solve_mals, AMEn_Opeye_ones_nDim2)
{
  ...
  double error = solveMALS(TTOpA, true, MALS_projection::RitzGalerkin, TTb, TTx, 1, eps, 10, 1, 0, 1);
  EXPECT_NEAR(0, error, eps);
...
TEST(PITTS_TensorTrain_solve_mals, AMEn_Opeye_ones_nDim2_PetrovGalerkin)
{
  ...
  double error = solveMALS(TTOpA, true, MALS_projection::PetrovGalerkin, TTb, TTx, 1, eps, 10, 1, 0, 1);
  EXPECT_NEAR(0, error, eps);
...
TEST(PITTS_TensorTrain_solve_mals, AMEn_Opeye_ones_nDim6_nonsymmetric_PetrovGalerkin)
{
  ...
  double error = solveMALS(TTOpA, false, MALS_projection::PetrovGalerkin, TTb, TTx, 1, eps, 10, 1, 0, 1);
  EXPECT_NEAR(0, error, eps);
...
TEST(PITTS_TensorTrain_solve_mals, AMEn_random_nDim2)
{
  ...
  double error = solveMALS(TTOpA, false, MALS_projection::NormalEquations, TTb, TTx, 2, eps, 10, 1, 0, 1);
  EXPECT_NEAR(0, error, 1.e-5*norm2(TTb));
...
TEST(PITTS_TensorTrain_solve_mals, AMEn_random_nDim6_nonsymmetric_RitzGalerkin)
{
  ...
  double error = solveMALS(TTOpA, false, MALS_projection::RitzGalerkin, TTb, TTx, 3, eps, 5, 1, 0, 1);
  EXPECT_NEAR(0, error, 0.05*norm2(TTb));
...
TEST(PITTS_TensorTrain_solve_mals, DISABLED_AMEn_random_nDim6_nonsymmetric_PetrovGalerkin)
{
  TensorTrainOperator_double TTOpA(6,4,4);
  TTOpA.setTTranks(1);
  randomize(TTOpA);
...
TEST(PITTS_TensorTrain_solve_mals, AMEn_random_nDim3_nonsymmetric_PetrovGalerkin)
{
  ...
  double error = solveMALS(TTOpA, false, MALS_projection::PetrovGalerkin, TTb, TTx, 2, eps, 5, 1, 0, 2);
  EXPECT_NEAR(0, error, 0.05*norm2(TTb));
...
TEST(PITTS_TensorTrain_solve_mals, DISABLED_AMEn_random_nDim6_nonsymmetric_least_squares)
{
  TensorTrainOperator_double TTOpA(6,5,4);
  TTOpA.setTTranks(2);
  randomize(TTOpA);
  ...
  double normalResidual = solveMALS(TTOpA, false, MALS_projection::NormalEquations, TTb, TTx, 3, eps, 5, 1, 0, 1);
  TensorTrain_double TTAtb(TTx.dimensions());
  applyT(TTOpA, TTb, TTAtb);
  EXPECT_NEAR(0, normalResidual, 0.5*norm2(TTAtb));
...
TEST(PITTS_TensorTrain_solve_mals, AMEn_symmetric_random_nDim6_rank1)
{
  ...
  double residualNorm = solveMALS(TTOpA, true, MALS_projection::RitzGalerkin, TTb, TTx, 5, eps, 2, 1, 0, 1);
...
TEST(PITTS_TensorTrain_solve_mals, AMEn_symmetric_random_nDim5)
{
  ...
  double residualNorm = solveMALS(TTOpA, true, MALS_projection::RitzGalerkin, TTb, TTx, 5, eps, 10, 1, 0, 1);
