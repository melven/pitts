...
TEST(PITTS_TensorTrain_solve_mals, AMEn_ALS_Opeye_ones_nDim2)
{
  TensorTrainOperator_double TTOpA(2,5,5);
  TTOpA.setEye();
  TensorTrain_double TTx(2,5), TTb(2,5);
  ...
  double error = solveMALS(TTOpA, true, MALS_projection::RitzGalerkin, TTb, TTx, 1, eps, 10, 1, 0, 1, false, 1);
  EXPECT_NEAR(0, error, eps);
...
TEST(PITTS_TensorTrain_solve_mals, AMEn_ALS_Opeye_ones_nDim6)
{
  TensorTrainOperator_double TTOpA(6,5,5);
  TTOpA.setEye();
  TensorTrain_double TTx(6,5), TTb(6,5);
...
TEST(PITTS_TensorTrain_solve_mals, AMEn_ALS_Opeye_ones_nDim2_PetrovGalerkin)
{
  TensorTrainOperator_double TTOpA(2,5,5);
  TTOpA.setEye();
  TensorTrain_double TTx(2,5), TTb(2,5);
  ...
  double error = solveMALS(TTOpA, true, MALS_projection::PetrovGalerkin, TTb, TTx, 1, eps, 10, 1, 0, 1, false, 1);
  EXPECT_NEAR(0, error, eps);
...
TEST(PITTS_TensorTrain_solve_mals, AMEn_ALS_Opeye_ones_nDim6_PetrovGalerkin)
{
  TensorTrainOperator_double TTOpA(6,5,5);
  TTOpA.setEye();
  TensorTrain_double TTx(6,5), TTb(6,5);
...
TEST(PITTS_TensorTrain_solve_mals, AMEn_ALS_Opeye_ones_nDim6_nonsymmetric_PetrovGalerkin)
{
  TensorTrainOperator_double TTOpA(6,4,4);
  TTOpA.setEye();
  TensorTrain_double TTx(6,4), TTb(6,4);
  ...
  double error = solveMALS(TTOpA, false, MALS_projection::PetrovGalerkin, TTb, TTx, 1, eps, 10, 1, 0, 1, false, 1);
  EXPECT_NEAR(0, error, eps);
...
TEST(PITTS_TensorTrain_solve_mals, AMEn_ALS_Opeye_ones_nDim6_nonsymmetric_least_squares)
{
  TensorTrainOperator_double TTOpA(6,5,4);
  TTOpA.setEye();
  TensorTrain_double TTx(6,4), TTb(6,5);
  ...
  double error = solveMALS(TTOpA, false, MALS_projection::NormalEquations, TTb, TTx, 1, eps, 10, 1, 0, 1, false, 1);
  EXPECT_NEAR(0, error, eps);
...
TEST(PITTS_TensorTrain_solve_mals, ALS_random_nDim2_rank1)
{
  ...
  double error = solveMALS(TTOpA, false, MALS_projection::NormalEquations, TTb, TTx, 2, eps, 2, 1, 0);
  EXPECT_NEAR(0, error, eps);
...
TEST(PITTS_TensorTrain_solve_mals, AMEn_ALS_random_nDim2_rank1)
{
  TensorTrainOperator_double TTOpA(2,5,5);
  TTOpA.setTTranks(1);
  randomize(TTOpA);
  ...
  double error = solveMALS(TTOpA, false, MALS_projection::NormalEquations, TTb, TTx, 5, eps, 2, 1, 0, 1, false, 2);
  EXPECT_NEAR(0, error, eps);
...
TEST(PITTS_TensorTrain_solve_mals, AMEn_ALS_random_nDim2)
{
  TensorTrainOperator_double TTOpA(2,2,2);
  TTOpA.setTTranks(2);
  randomize(TTOpA);
  ...
  double error = solveMALS(TTOpA, false, MALS_projection::NormalEquations, TTb, TTx, 2, eps, 10, 1, 0, 1, false, 2);
  EXPECT_NEAR(0, error, 1.e-5*norm2(TTb));
...
TEST(PITTS_TensorTrain_solve_mals, AMEn_ALS_random_nDim6_nonsymmetric_RitzGalerkin)
{
  TensorTrainOperator_double TTOpA(6,4,4);
  TTOpA.setTTranks(1);
  randomize(TTOpA);
  ...
  double error = solveMALS(TTOpA, false, MALS_projection::RitzGalerkin, TTb, TTx, 3, eps, 5, 1, 0, 1, false, 2);
  EXPECT_NEAR(0, error, 0.05*norm2(TTb));
...
TEST(PITTS_TensorTrain_solve_mals, AMEn_ALS_random_nDim3_nonsymmetric_PetrovGalerkin)
{
  TensorTrainOperator_double TTOpA(3,2,2);
  TTOpA.setTTranks(1);
  randomize(TTOpA);
...
TEST(PITTS_TensorTrain_solve_mals, AMEn_ALS_symmetric_random_nDim6_rank1)
{
  TensorTrainOperator_double TTOp_tmp(6,5,4);
  TTOp_tmp.setTTranks(1);
  randomize(TTOp_tmp);
  ...
  double residualNorm = solveMALS(TTOpA, true, MALS_projection::RitzGalerkin, TTb, TTx, 5, eps, 2, 1, 0, 1, false, 2);
...
TEST(PITTS_TensorTrain_solve_mals, simplified_AMEn_symmetric_random_nDim4)
{
  TensorTrainOperator_double TTOp_tmp(4,4,6);
  TTOp_tmp.setTTranks(2);
  randomize(TTOp_tmp);
  TensorTrainOperator_double TTOpA(4,6,6);
  applyT(TTOp_tmp, TTOp_tmp, TTOpA);
  normalize(TTOpA);

  TensorTrainOperator_double TTOpI(4,6,6);
  TTOpI.setEye();
  const double Inrm = normalize(TTOpI);
  axpby(Inrm, TTOpI, Inrm/20, TTOpA);

  TensorTrain_double TTx(4,6), TTb(4,6), TTx_ref(4,6), TTr(4,6), TTdx(4,6);
  TTx_ref.setTTranks(2);
  randomize(TTx_ref);
  apply(TTOpA, TTx_ref, TTb);
...
TEST(PITTS_TensorTrain_solve_mals, AMEn_symmetric_random_nDim4)
{
  TensorTrainOperator_double TTOp_tmp(4,4,6);
  TTOp_tmp.setTTranks(2);
  randomize(TTOp_tmp);
...
TEST(PITTS_TensorTrain_solve_mals, AMEn_ALS_symmetric_random_nDim4)
{
  TensorTrainOperator_double TTOp_tmp(4,4,6);
  TTOp_tmp.setTTranks(2);
  randomize(TTOp_tmp);
  ...
  double residualNorm = solveMALS(TTOpA, true, MALS_projection::RitzGalerkin, TTb, TTx, 5, eps, 10, 1, 0, 1, false, 3);
...
TEST(PITTS_TensorTrain_solve_mals, MALS_symmetric_random_nDim5)
{
  ...
  double residualNorm = solveMALS(TTOpA, true, MALS_projection::RitzGalerkin, TTb, TTx, 1, eps, 10, 2, 1, 0, false, 0, false, 25, eps);
...
TEST(PITTS_TensorTrain_solve_mals, DISABLED_MALS_symmetric_random_nDim5_with_TTgmres)
{
  ...
  double residualNorm = solveMALS(TTOpA, true, MALS_projection::RitzGalerkin, TTb, TTx, 1, eps, 10, 2, 1, 0, false, 0, true);
