...
TEST(PITTS_TensorTrainOperator, create_n_m_1)
{
  ...
  ASSERT_EQ(1, TT1.tensorTrain().subTensors().size());
  ASSERT_EQ(1, TT1.tensorTrain().subTensors()[0].r1());
  ASSERT_EQ(3*4, TT1.tensorTrain().subTensors()[0].n());
  ASSERT_EQ(1, TT1.tensorTrain().subTensors()[0].r2());
}
...
TEST(PITTS_TensorTrainOperator, create_n_m_d)
{
  ...
  ASSERT_EQ(3, TT1.tensorTrain().subTensors().size());
  for(const auto& subT: TT1.tensorTrain().subTensors())
  {
    ASSERT_EQ(1, subT.r1());
  ...
  ASSERT_EQ(2, TT2.tensorTrain().subTensors().size());
  ASSERT_EQ(1, TT2.tensorTrain().subTensors()[0].r1());
  ASSERT_EQ(3*7, TT2.tensorTrain().subTensors()[0].n());
  ASSERT_EQ(4, TT2.tensorTrain().subTensors()[0].r2());
  ASSERT_EQ(4, TT2.tensorTrain().subTensors()[1].r1());
  ASSERT_EQ(3*7, TT2.tensorTrain().subTensors()[1].n());
  ASSERT_EQ(1, TT2.tensorTrain().subTensors()[1].r2());
}
...
TEST(PITTS_TensorTrainOperator, create_generic)
{
  ...
  ASSERT_EQ(5, TT.tensorTrain().subTensors().size());
  ASSERT_EQ(1, TT.tensorTrain().subTensors()[0].r1());
  ASSERT_EQ(2*6, TT.tensorTrain().subTensors()[0].n());
  ASSERT_EQ(3, TT.tensorTrain().subTensors()[0].r2());
  ASSERT_EQ(3, TT.tensorTrain().subTensors()[1].r1());
  ASSERT_EQ(3*5, TT.tensorTrain().subTensors()[1].n());
  ASSERT_EQ(3, TT.tensorTrain().subTensors()[1].r2());
  ASSERT_EQ(3, TT.tensorTrain().subTensors()[2].r1());
  ASSERT_EQ(4*4, TT.tensorTrain().subTensors()[2].n());
  ASSERT_EQ(3, TT.tensorTrain().subTensors()[2].r2());
  ASSERT_EQ(3, TT.tensorTrain().subTensors()[3].r1());
  ASSERT_EQ(5*3, TT.tensorTrain().subTensors()[3].n());
  ASSERT_EQ(3, TT.tensorTrain().subTensors()[3].r2());
  ASSERT_EQ(3, TT.tensorTrain().subTensors()[4].r1());
  ASSERT_EQ(6*1, TT.tensorTrain().subTensors()[4].n());
  ASSERT_EQ(1, TT.tensorTrain().subTensors()[4].r2());
}
...
TEST(PITTS_TensorTrainOperator, setTTranks)
{
  ...
  ASSERT_EQ(3, TT.tensorTrain().subTensors().size());
  ASSERT_EQ(1, TT.tensorTrain().subTensors()[0].r1());
  ASSERT_EQ(5*2, TT.tensorTrain().subTensors()[0].n());
  ASSERT_EQ(2, TT.tensorTrain().subTensors()[0].r2());
  ASSERT_EQ(2, TT.tensorTrain().subTensors()[1].r1());
  ASSERT_EQ(5*2, TT.tensorTrain().subTensors()[1].n());
  ASSERT_EQ(2, TT.tensorTrain().subTensors()[1].r2());
  ASSERT_EQ(2, TT.tensorTrain().subTensors()[2].r1());
  ASSERT_EQ(5*2, TT.tensorTrain().subTensors()[2].n());
  ASSERT_EQ(1, TT.tensorTrain().subTensors()[2].r2());
  ...
  ASSERT_EQ(3, TT.tensorTrain().subTensors()[1].r1());
  ASSERT_EQ(5*2, TT.tensorTrain().subTensors()[1].n());
  ASSERT_EQ(4, TT.tensorTrain().subTensors()[1].r2());
  ASSERT_EQ(4, TT.tensorTrain().subTensors()[2].r1());
  ASSERT_EQ(5*2, TT.tensorTrain().subTensors()[2].n());
  ASSERT_EQ(1, TT.tensorTrain().subTensors()[2].r2());
}
...
TEST(PITTS_TensorTrainOperator, setZero)
{
  ...
  for(const auto& subT: TT.tensorTrain().subTensors())
  {
    ASSERT_EQ(1, subT.r1());
...
TEST(PITTS_TensorTrainOperator, setEye)
{
  ...
  for(int iDim = 0; iDim < TT.tensorTrain().subTensors().size(); iDim++)
  {
    const auto& subT = TT.tensorTrain().subTensors()[iDim];
    ASSERT_EQ(1, subT.r1());
    ASSERT_EQ(4*3, subT.n());
    ASSERT_EQ(1, subT.r2());
    for(int i = 0; i < 4; i++)
...
TEST(PITTS_TensorTrainOperator, copy)
{
  ...
  int dummyVal = 0;
  for(auto& subT: TT1.tensorTrain().editableSubTensors())
  {
  ...
  ASSERT_EQ(TT1.tensorTrain().subTensors().size(), TT2.tensorTrain().subTensors().size());
  for(int iDim = 0; iDim < TT1.tensorTrain().subTensors().size(); iDim++)
  {
    const auto& subT1 = TT1.tensorTrain().subTensors()[iDim];
    const auto& subT2 = TT2.tensorTrain().subTensors()[iDim];
