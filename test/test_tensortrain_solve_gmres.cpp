...
TEST(PITTS_TensorTrain_solve_gmres, Opeye_ones_nDim1)
{
  ...
  double error = solveGMRES(TTOpA, TTb, TTx, 0, eps, eps, 999, true, "test: ", true);
...
TEST(PITTS_TensorTrain_solve_gmres, Opeye_ones_nDim2_guess_zero)
{
  ...
  double error = solveGMRES(TTOpA, TTb, TTx, 1, eps, eps, 999, true, "test: ", true);
  EXPECT_NEAR(0, error, eps);
...
TEST(PITTS_TensorTrain_solve_gmres, random_nDim1)
{
  ...
  double error = solveGMRES(TTOpA, TTb, TTx, 5, eps, eps, 999, true, "test: ", true);
  EXPECT_NEAR(0, error, eps);
...
TEST(PITTS_TensorTrain_solve_gmres, symmetric_random_nDim1)
{
...
TEST(PITTS_TensorTrain_solve_gmres, random_nDim2_rank1)
{
  ...
  double error = solveGMRES(TTOpA, TTb, TTx, 25, eps, eps, 999, true, "test: ", true);
...
TEST(PITTS_TensorTrain_solve_gmres, random_nDim2)
{
  ...
  double error = solveGMRES(TTOpA, TTb, TTx, 4, eps, eps, 999, true, "test: ", true);
...
TEST(PITTS_TensorTrain_solve_gmres, symmetric_random_nDim6_rank1)
{
  ...
  double residualNorm = solveGMRES(TTOpA, TTb, TTx, 25, 0.01, 0.01, 999, true, "test: ", true);
...
TEST(PITTS_TensorTrain_solve_gmres, symmetric_random_nDim6)
{
  TensorTrainOperator_double TTOp_tmp(6,5,4);
