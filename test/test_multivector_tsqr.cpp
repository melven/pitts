...
TEST(PITTS_MultiVector_tsqr, internal_apply2HouseholderRotations_inplace)
{
  constexpr auto eps = 1.e-8;
  using Chunk = PITTS::Chunk<double>;
  using MultiVector = PITTS::MultiVector<double>;
  ...
  PITTS::HouseholderQR::internal::apply2HouseholderRotations(nChunks, firstRow, col, &w.chunk(0,0), &v.chunk(0,0), vTw_chunk, &X.chunk(0,0), nChunks, &X.chunk(0,0));
...
TEST(PITTS_MultiVector_tsqr, internal_apply2HouseholderRotations_out_of_place)
{
  constexpr auto eps = 1.e-8;
  using Chunk = PITTS::Chunk<double>;
  using MultiVector = PITTS::MultiVector<double>;
  ...
  PITTS::HouseholderQR::internal::apply2HouseholderRotations(nChunks, firstRow, col, &w.chunk(0,0), &v.chunk(0,0), vTw_chunk, &X_in.chunk(0,0), lda, &X.chunk(0,0));
