...
// just import the module if we are in module mode and this file is not included from pitts_tensortrain_to_dense.cppm
#if defined(PITTS_USE_MODULES) && !defined(EXPORT_PITTS_TENSORTRAIN_TO_DENSE)
import pitts_tensortrain_to_dense;
...
// module export
#ifdef PITTS_USE_MODULES
export module pitts_tensortrain_to_dense;
