...
template void PITTS::transform<double>(MultiVector<double>& X, const ConstTensor2View<double>& M);
template void PITTS::transform<float>(MultiVector<float>& X, const ConstTensor2View<float>& M);
