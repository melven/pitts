...
template bool check_AMEnSubspace(const TensorTrainOperator<float>& TTOpA, const TensorTrain<float>& TTv, const TensorTrain<float>& TTx, const TensorTrain<float>& TTb, SweepIndex swpIdx, bool leftToRight, const TensorTrain<float>& tt_z, const TensorTrain<float>& TTz);
template bool check_AMEnSubspace(const TensorTrainOperator<double>& TTOpA, const TensorTrain<double>& TTv, const TensorTrain<double>& TTx, const TensorTrain<double>& TTb, SweepIndex swpIdx, bool leftToRight, const TensorTrain<double>& tt_z, const TensorTrain<double>& TTz);
