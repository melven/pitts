...
namespace PITTS
{
  ...
  namespace pybind
  {
    namespace
    {
      ...
      {
        m.def("solveMALS",
            py::overload_cast< const TensorTrainOperator<T>&, bool, const TensorTrain<T>&, TensorTrain<T>&, int, T, int, int, int, bool>(&solveMALS<T>),
            ...
            py::arg("nMALS")=2, py::arg("nOverlap")=1, py::arg("useTTgmres")=false,
