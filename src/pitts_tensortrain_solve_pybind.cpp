...
namespace PITTS
{
  ...
  namespace pybind
  {
    namespace
    {
      ...
      {
        m.def("solveMALS",
            py::overload_cast< const TensorTrainOperator<T>&, bool, MALS_projection, const TensorTrain<T>&, TensorTrain<T>&, int, T, int, int, int, int, bool, int, T>(&solveMALS<T>),
            ...
            py::arg("nMALS")=2, py::arg("nOverlap")=1, py::arg("nAMEnEnrichtment")=0,
