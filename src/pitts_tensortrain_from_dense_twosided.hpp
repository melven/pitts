...
// just import the module if we are in module mode and this file is not included from pitts_tensortrain_from_dense_twosided.cppm
#if defined(PITTS_USE_MODULES) && !defined(EXPORT_PITTS_TENSORTRAIN_FROM_DENSE_TWOSIDED)
import pitts_tensortrain_from_dense_twosided;
...
// module export
#ifdef PITTS_USE_MODULES
export module pitts_tensortrain_from_dense_twosided;
