/*! @file pitts_tensortrain_from_dense_classical_impl.hpp
...
// include guard
#ifndef PITTS_TENSORTRAIN_FROM_DENSE_CLASSICAL_IMPL_HPP
#define PITTS_TENSORTRAIN_FROM_DENSE_CLASSICAL_IMPL_HPP
...
namespace PITTS
{
  ...
  TensorTrain<T> fromDense_classical(const Iter first, const Iter last, const std::vector<int>& dimensions, T rankTolerance , int maxRank)
  {
    // timer
...
#endif // PITTS_TENSORTRAIN_FROM_DENSE_CLASSICAL_IMPL_HPP
