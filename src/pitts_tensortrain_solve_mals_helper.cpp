...
{
template void update_right_Ax(const TensorTrainOperator<float> TTOpA, const TensorTrain<float>& TTx, int firstIdx, int lastIdx, std::vector<Tensor3<float>>& right_Ax);
template void update_right_Ax(const TensorTrainOperator<double> TTOpA, const TensorTrain<double>& TTx, int firstIdx, int lastIdx, std::vector<Tensor3<double>>& right_Ax);
