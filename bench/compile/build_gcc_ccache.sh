...
time -p cmake -Wno-dev -G Ninja -DCMAKE_BUILD_TYPE=$1 -DPITTS_EIGEN_USE_LAPACKE=On -DCMAKE_CXX_COMPILER_LAUNCHER=ccache -DPITTS_USE_MODULES=Off -DCMAKE_CXX_COMPILER=g++ ../../.. > cmake.log
